...
{
    [CustomEditor(typeof(CannonShootAction), true)]
    public class CannonShootActionEditor : RepeatableActionEditor
    {
        ...
        SerializedProperty m_ShootPointProp;
        ...
        protected override void OnEnable()
        {
            ...
            m_ShootPointProp = serializedObject.FindProperty("m_ShootPoint");
        }
        ...
        protected override void CreateGUI()
        {
            ...
            EditorGUILayout.PropertyField(m_ShootPointProp);
